...
test("internal workspace renders the regulation-based YG plan without claiming official zoning", () => {
  ...
  for (const id of [
    ...
    "rdtr-export-road-evidence", "rdtr-export-service-evidence", "rdtr-export-service-access", "rdtr-export-readiness", "rdtr-export-programmes", "rdtr-export-consultation", "rdtr-consultation-matrix", "rdtr-network-evidence", "rdtr-service-evidence", "rdtr-service-access", "rdtr-development-readiness", "rdtr-network-gaps", "rdtr-pattern-plan",
