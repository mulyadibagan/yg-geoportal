(function(){
  ...
  function selectProduct(id){document.querySelectorAll('[data-product]').forEach(function(b){b.classList.toggle('active',b.dataset.product===id)});if(id==='hotspots'){setLayerChecked('hotspots',true)}if(id==='wind'){setLayerChecked('wind',true)}if(id==='rain'){setLayerChecked('rain',true)}if(id==='smoke'){if(period===7||period===30)applyPeriodButton(document.querySelector('#period-control [data-period="latest"]'));setLayerChecked('smoke',true);setLayerChecked('hotspots',false);setLayerChecked('wind',true)}}
