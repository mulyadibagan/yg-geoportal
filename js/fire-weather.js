(function(){
  ...
  function periodLabel(){return period===1?(observationDate===currentDate?'24 jam bergulir':'24 jam sampai akhir tanggal'):period===7?'7 hari · sumber berulang':period+' hari'}
  ...
  function requestTransportIfNeeded(){
    if(period===1&&observationDate===currentDate&&map.hasLayer(groups.smoke)&&!transportReady)ensureTransportWeather();
  }
