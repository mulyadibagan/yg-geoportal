(() => {
  ...
  // Inject styles for the detailed SDG contribution lists
  const sdgStyle = document.createElement('style');
  sdgStyle.textContent = `
  ...
  `;
  document.head.appendChild(sdgStyle);
  ...
  const sdgContributions = [
    ...
    },
    {
      ...
      contribution: '<ul><li>Menciptakan <i>green jobs</i> di tingkat desa (pembibitan, penanaman, pemantauan).</li><li>Mendukung wirausaha perempuan melalui kelompok tani kopi.</li><li>Membangun kemitraan pasar untuk produk kopi Liberika.</li></ul>',
      icon: 'assets/sdg-icons/sdg-8.png'
    },
    {
      goal: 11,
      title: 'Kota dan Permukiman Berkelanjutan',
      contribution: '<ul><li>Pembangunan <i>hybrid engineering</i> (APO) untuk melindungi garis pantai dan permukiman.</li><li>Pemasangan sistem peringatan dini kebakaran (FDRS).</li><li>Peningkatan kapasitas masyarakat dalam pencegahan kebakaran lahan.</li></ul>',
