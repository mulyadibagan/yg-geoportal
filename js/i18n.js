(() => {
  ...
  Object.assign(dictionaries.en, {
    ...
    "Kontur Potensi Transport Asap": "Smoke Transport Potential Contours",
    "Dukungan model relatif · bukan PM2.5": "Relative model support · not PM2.5",
    "Referensi 925 hPa · interpolasi": "925 hPa reference · interpolated",
    "Waktu hotspot & kontur": "Hotspot & contour period",
    "Polygon kontur potensi transport asap": "Smoke-transport potential contour polygons",
    ...
    "Kontur menggabungkan kepadatan relatif lintasan sekitar 500, 800, dan 1.500 m dpl. Panah peta memakai 925 hPa sebagai referensi.": "Contours combine relative trajectory density at about 500, 800, and 1,500 m ASL. Map arrows use 925 hPa as the reference.",
    "Deteksi hotspot confidence tinggi": "High-confidence hotspot detection",
    "Jejak model terluar · P20–P50": "Outer model trace · P20–P50",
    "Dukungan model terbatas · P50–P75": "Limited model support · P50–P75",
    "Dukungan model sedang · P75–P90": "Moderate model support · P75–P90",
    "Dukungan model kuat · ≥P90": "Strong model support · ≥P90",
    "Desa: 1–2 deteksi": "Village: 1–2 detections",
    "Desa: 3–5 deteksi": "Village: 3–5 detections",
    "Desa: >5 deteksi": "Village: >5 detections",
    "Kontur potensi transport asap": "Smoke transport potential contours",
    "Aktifkan layer untuk menampilkan polygon kontur empat warna dari lintasan multi-ketinggian.": "Enable the layer to show four-color contour polygons from multi-height trajectories.",
    "Kontur menunjukkan dukungan relatif lintasan transport pada jendela waktu aktif. Hijau hingga merah berarti dukungan model makin kuat dalam pemodelan yang sama, bukan konsentrasi asap, PM2.5, probabilitas, atau tingkat bahaya kesehatan.": "Contours show relative trajectory-transport support within the active time window. Green through red means stronger support within the same model run, not smoke concentration, PM2.5, probability, or a health-hazard level.",
    "Sumber dan batas model:": "Sources and model limits:",
    "NASA FIRMS NRT (MODIS dan VIIRS) untuk hotspot berkeyakinan tinggi; GFS/Open-Meteo untuk angin 950, 925, dan 850 hPa; RainViewer untuk radar hujan; NASA GIBS untuk citra MODIS; serta data lapangan YG. Deteksi antarsatelit dalam radius 1,5 km dan 90 menit dikelompokkan. Setiap kelompok sumber berbobot total sama, lalu lintasan tiga ketinggian dihaluskan dengan kernel Gaussian pada skala sampling angin dan diubah menjadi isoband relatif P20/P50/P75/P90. FRP dan AOD tidak menentukan warna.": "NASA FIRMS NRT (MODIS and VIIRS) supplies high-confidence hotspots; GFS/Open-Meteo supplies 950, 925, and 850 hPa winds; RainViewer supplies rain radar; NASA GIBS supplies MODIS imagery; and YG supplies field data. Cross-satellite detections within 1.5 km and 90 minutes are grouped. Every source cluster has equal total weight; three-height paths are smoothed with a Gaussian kernel at the sampled wind-grid scale and converted to relative P20/P50/P75/P90 isobands. FRP and AOD do not set the colors.",
