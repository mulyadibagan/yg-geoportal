(() => {
  ...
  Object.assign(dictionaries.en, {
    ...
    "Polygon Transport Asap Eksperimental": "Experimental Smoke-Transport Polygons",
    "Selubung model · bukan PM2.5": "Model envelope · not PM2.5",
    "Referensi 925 hPa · interpolasi": "925 hPa reference · interpolated",
    "Waktu hotspot & polygon": "Hotspot & polygon period",
    "Polygon transport asap eksperimental": "Experimental smoke-transport polygons",
    ...
    "Polygon menggabungkan tiga sensitivitas ketinggian sekitar 500, 800, dan 1.500 m dpl. Lebarnya bertambah menurut umur parcel; panah peta memakai 925 hPa sebagai referensi.": "Polygons combine three height sensitivities at about 500, 800, and 1,500 m ASL. Width grows with parcel age; map arrows use 925 hPa as the reference.",
    "Deteksi hotspot confidence tinggi": "High-confidence hotspot detection",
    "Zona utama model · σh": "Primary model zone · σh",
    "Batas ketidakpastian · 1,54σh": "Uncertainty boundary · 1.54σh",
    "Desa: 1–2 deteksi": "Village: 1–2 detections",
    "Desa: 3–5 deteksi": "Village: 3–5 detections",
    "Desa: >5 deteksi": "Village: >5 detections",
    "Aktifkan layer dan pilih Sekarang atau 24 jam untuk membentuk polygon koridor sejak deteksi.": "Enable the layer and select Current or 24 hours to build corridor polygons since detection.",
    "Polygon menunjukkan koridor kumulatif potensi transport udara sejak deteksi hotspot pada tiga lapisan GFS. Zona utama, batas ketidakpastian, dan area yang saling menumpuk bukan plume asap teramati, bukan konsentrasi PM2.5, dan bukan prakiraan kesehatan.": "Polygons show cumulative potential air-transport corridors since hotspot detection at three GFS levels. The primary zone, uncertainty boundary, and overlapping areas are not observed smoke plumes, PM2.5 concentrations, or health forecasts.",
    "Sumber dan batas model:": "Sources and model limits:",
    "NASA FIRMS NRT (MODIS dan VIIRS) untuk deteksi hotspot berkeyakinan tinggi dan FRP; GFS/Open-Meteo untuk angin 950, 925, dan 850 hPa; RainViewer untuk radar hujan; NASA GIBS untuk citra MODIS; serta data lapangan YG. Deteksi berbeda satelit dalam radius 1,5 km dan 90 menit dikelompokkan sebelum menjadi sumber. Polygon memakai adveksi horizontal yang diinterpolasi ruang–waktu, sensitivitas tiga ketinggian, radius awal 1,5 km, serta pertumbuhan sigma horizontal 1,853 km/jam dengan batas luar 1,54σh sebagai parameter eksplisit.": "NASA FIRMS NRT (MODIS and VIIRS) supplies high-confidence hotspot detections and FRP; GFS/Open-Meteo supplies 950, 925, and 850 hPa winds; RainViewer supplies rain radar; NASA GIBS supplies MODIS imagery; and YG supplies field data. Detections from different satellites within 1.5 km and 90 minutes are grouped before becoming sources. Polygons use space-time interpolated horizontal advection, three height sensitivities, a 1.5 km initial radius, and an explicit horizontal sigma growth of 1.853 km/hour with a 1.54σh outer boundary.",
    "Persamaan puff HYSPLIT": "HYSPLIT puff equations",
    "Nilai default historis NOAA": "NOAA historical defaults",
    "Model belum menghitung plume rise, stabilitas/PBL, turbulensi terukur, pencampuran vertikal, deposisi, emisi massa, probabilitas, atau konsentrasi.": "The model does not calculate plume rise, stability/PBL, measured turbulence, vertical mixing, deposition, mass emissions, probability, or concentration.",
    "Sekarang dan 24 jam membentuk polygon koridor transport sejak deteksi hingga kini; 7 hari menampilkan sumber berulang; 30 hari hanya marker historis.": "Current and 24-hour periods build transport-corridor polygons from detection until now; 7 days shows recurring sources; 30 days shows historical markers only.",
    "Sekarang": "Current",
    "24 jam": "24 hours",
