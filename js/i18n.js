(() => {
  ...
  const dictionaries = {
    en: {
      ...
      "KOLABORASI AKADEMIK": "ACADEMIC COLLABORATION",
      "Kebun Percobaan Faperta UR": "Faperta UR Experimental Farm",
      "YG × Fakultas Pertanian Universitas Riau": "YG × Faculty of Agriculture, Universitas Riau",
      "Informasi kebun, cuaca, budidaya, pemantauan tanaman, hasil panen, dan penelitian.": "Farm, weather, cultivation, crop monitoring, harvest, and research information.",
      "3 area kebun · 9,46 hektare terpetakan": "3 farm areas · 9.46 hectares mapped",
      ...
      "PENGELOLAAN LAHAN BASAH BERKELANJUTAN": "SUSTAINABLE WETLAND MANAGEMENT",
      "Lahan basah lestari. Masyarakat berdaya.": "Thriving wetlands. Empowered communities.",
      "Mendukung pengelolaan sumber daya alam lahan basah dan ekosistem lain yang berkelanjutan melalui kemitraan strategis dengan berbagai pemangku kepentingan dan masyarakat lokal.": "Supporting the sustainable management of wetland natural resources and other ecosystems through strategic partnerships with diverse stakeholders and local communities.",
  ...
  Object.assign(dictionaries.en, {
    ...
    "Area Perkebunan Anggota RSPO": "RSPO Member Plantation Areas",
  ...
  Object.assign(dictionaries.en, {
    ...
    ,"Apikulat": "Apiculate"
    ,"Flora Gambut | Biodiversitas YG": "Peatland Flora | YG Biodiversity"
    ,"BIODIVERSITAS · EKOSISTEM GAMBUT": "BIODIVERSITY · PEATLAND ECOSYSTEM"
    ,"Jelajahi tanaman yang terdokumentasi melalui penelitian dan kegiatan lapangan pada lanskap gambut wilayah kerja Yayasan Gambut.": "Explore plants documented through research and field activities across peatland landscapes where Yayasan Gambut works."
    ,"Lihat spesies terdokumentasi": "View documented species"
    ,"spesies terdokumentasi": "documented species"
    ,"individu penelitian": "research individuals"
    ,"lokasi populasi": "population locations"
    ,"DAFTAR SPESIES": "SPECIES LIST"
    ,"Flora yang telah terdokumentasi": "Documented flora"
    ,"Setiap profil menyajikan sumber, lokasi, dan data yang tersedia.": "Each profile presents its sources, locations, and available data."
    ,"Dataset Penelitian · 2026": "Research Dataset · 2026"
    ,"TANAMAN BUDIDAYA LAHAN GAMBUT": "PEATLAND CULTIVATED PLANT"
    ,"Karakterisasi morfologi tanaman Kopi Liberika lokal pada enam populasi di Pulau Bengkalis.": "Morphological characterization of local Liberica Coffee across six populations on Bengkalis Island."
    ,"Buka profil dan data penelitian": "Open profile and research data"
    ,"TENTANG KATALOG": "ABOUT THE CATALOGUE"
    ,"Berbasis data yang dapat ditelusuri": "Built on traceable data"
    ,"Katalog menampilkan spesies yang telah didukung oleh data penelitian atau dokumentasi lapangan. Informasi setiap spesies disajikan bersama sumber dan konteks lokasinya.": "The catalogue presents species supported by research data or field documentation. Each species is shown with its source and location context."
  ...
  Object.assign(dictionaries.en, {
    ...
    "Keputusan Gubernur Riau Nomor Kpts.123/II/2026 menjadi dasar koordinasi percepatan akses dan peningkatan kualitas pengelolaan Perhutanan Sosial di Provinsi Riau.": "Riau Governor Decree No. Kpts.123/II/2026 provides the basis for coordinating faster access to and improved quality of Social Forestry management in Riau Province.",
    "Keterlibatan YG": "YG participation",
    "Anggota Sekretariat Pokja PPS": "Member of the Pokja PPS Secretariat",
    "Mandat utama": "Core mandate",
    "Pencermatan PIAPS, fasilitasi persetujuan dan verifikasi teknis, penataan areal, pengembangan usaha, penyelesaian konflik, serta manajemen informasi.": "PIAPS review, approval facilitation and technical verification, area arrangement, enterprise development, conflict resolution, and information management.",
    "Lihat struktur lengkap": "View full structure",
    "Buka dokumen SK": "Open decree",
    "Struktur Pokja PPS Riau 2026 | YG GeoPortal": "Riau Pokja PPS Structure 2026 | YG GeoPortal",
    "← Kembali ke Direktori PS": "← Back to Social Forestry Directory",
    "KELEMBAGAAN PERHUTANAN SOSIAL RIAU": "RIAU SOCIAL FORESTRY GOVERNANCE",
    "Struktur Pokja PPS Provinsi Riau": "Riau Provincial Pokja PPS Structure",
    "Susunan Kelompok Kerja Percepatan Perhutanan Sosial dan Sekretariat berdasarkan Keputusan Gubernur Riau Nomor Kpts.123/II/2026.": "Structure of the Social Forestry Acceleration Working Group and Secretariat under Riau Governor Decree No. Kpts.123/II/2026.",
    "STRUKTUR ORGANISASI": "ORGANISATIONAL STRUCTURE",
    "Pokja PPS Provinsi Riau": "Riau Provincial Pokja PPS",
    "Susunan berikut disajikan menurut Lampiran I dan Lampiran II SK. Nama orang ditampilkan hanya apabila disebutkan secara langsung dalam dokumen.": "The following structure is presented according to Annexes I and II of the decree. Personal names are shown only where stated directly in the document.",
    "Pembina, penasihat, dan pengurus": "Advisors and executive officers",
    "Bidang penyiapan kawasan": "Area preparation",
    "Bidang pengembangan usaha": "Enterprise development",
    "Basis data dan sosialisasi": "Database and outreach",
    "Pengendalian Perhutanan Sosial": "Social Forestry oversight",
    "Resolusi konflik": "Conflict resolution",
    "Sekretariat Pokja PPS": "Pokja PPS Secretariat",
    "Yayasan Gambut tercantum sebagai salah satu unsur anggota Sekretariat.": "Yayasan Gambut is listed as a member of the Secretariat.",
    "Struktur": "Structure",
    "Nama/Jabatan": "Name/Position",
    "Instansi/Lembaga": "Institution/Organisation",
    "Institusi": "Institution",
    "Pembina/Penasihat": "Advisors",
    "Ketua": "Chair",
    "Ketua Harian": "Executive Chair",
    "Wakil Ketua": "Deputy Chair",
    "Sekretaris": "Secretary",
    "Wakil Sekretaris": "Deputy Secretary",
    "Anggota": "Members",
    "Kepala Sekretariat Perhutanan Sosial": "Head of the Social Forestry Secretariat",
    "Sumber resmi": "Official source",
    "Keputusan Gubernur Riau Nomor Kpts.123/II/2026, ditetapkan 25 Februari 2026.": "Riau Governor Decree No. Kpts.123/II/2026, established on 25 February 2026.",
    "Buka dokumen asli": "Open original document",
    "Gubernur Riau": "Governor of Riau",
    "Kepala Daerah Provinsi Riau": "Head of Riau Provincial Government",
    "Ketua DPRD Provinsi Riau": "Speaker of the Riau Provincial Legislative Council",
    "Sekretaris Daerah": "Regional Secretary",
    "Sekretariat Daerah Provinsi Riau": "Riau Provincial Secretariat",
    "Ketua Pokja PPS Riau Periode 2023-2025": "Chair of Riau Pokja PPS, 2023-2025 term",
    "Koordinator DPW FKKM Riau": "Riau Regional Coordinator, FKKM",
    "Kepala Dinas LHK Provinsi Riau": "Head of Riau Provincial Environment and Forestry Agency",
    "Kabid. Pengelolaan DAS, Restorasi Gambut dan PS": "Head of Watershed Management, Peatland Restoration and Social Forestry",
    "Asosiasi Pengelola PS Indonesia-Riau": "Indonesian Social Forestry Managers Association - Riau",
    "Koordinator Penyiapan Kawasan Perhutanan Sosial": "Social Forestry Area Preparation Coordinator",
    "Kabid. Perencanaan dan Pemanfaatan Kawasan Hutan": "Head of Forest Area Planning and Utilisation",
    "Sekretaris Jenderal JMGR": "Secretary General, JMGR",
    "Kepala Balai Perhutanan Sosial Kampar": "Head of Kampar Social Forestry Centre",
    "Ketua Pengurus Daerah": "Regional Executive Chair",
    "Koordinator Pengembangan Usaha Perhutanan Sosial": "Social Forestry Enterprise Development Coordinator",
    "Kabid. Perekonomian dan Sumber Daya Alam": "Head of Economy and Natural Resources",
    "Penata Perijinan Madya": "Associate Licensing Officer",
    "Kabid. Koperasi dan Usaha Kecil Menengah": "Head of Cooperatives and Small and Medium Enterprises",
    "Kabid. Pengembangan Usaha dan Penyuluhan": "Head of Enterprise Development and Extension",
    "Kabid. Agribisnis Peternakan": "Head of Livestock Agribusiness",
    "Kabid. Pengolahan dan Pemasaran Hasil Kelautan dan Perikanan": "Head of Marine and Fisheries Product Processing and Marketing",
    "Kepala BPHL Wilayah III Pekanbaru": "Head of BPHL Region III Pekanbaru",
    "Kepala BPDAS Indragiri-Rokan": "Head of BPDAS Indragiri-Rokan",
    "Kabid. Ekonomi Kreatif": "Head of Creative Economy",
    "Direktur BUMD": "Director of Regional-Owned Enterprise",
    "Direktur Perkumpulan Elang": "Director, Perkumpulan Elang",
    "Direktur LPER": "Director, LPER",
    "Direktur LRII": "Director, LRII",
    "Koordinator Basis Data dan Sosialisasi Perhutanan Sosial": "Social Forestry Database and Outreach Coordinator",
    "Koordinator Jikalahari": "Jikalahari Coordinator",
    "Kepala UPT KPH se-Provinsi Riau": "Heads of Forest Management Units across Riau Province",
    "Kabid. Informasi dan Komunikasi Publik": "Head of Information and Public Communications",
    "Kepala BPS Provinsi": "Head of Provincial Statistics Office",
    "Ketua Perkumpulan Ara Sati Hakiki": "Chair, Perkumpulan Ara Sati Hakiki",
    "Direktur Yayasan Hutan Riau": "Director, Yayasan Hutan Riau",
    "Senior Program Lead Regional Riau": "Senior Program Lead, Riau Region",
    "Koordinator Penyuluh Kehutanan": "Forestry Extension Coordinator",
    "Koordinator Pengendalian Perhutanan Sosial": "Social Forestry Oversight Coordinator",
    "Direktur LPESM Riau": "Director, LPESM Riau",
    "Kabid. Pemberdayaan Masyarakat": "Head of Community Empowerment",
    "Kabid. Pengembangan Sumber Daya Pariwisata": "Head of Tourism Resource Development",
    "Kabid. Kelautan dan Pengawasan": "Head of Marine Affairs and Supervision",
    "Project Manager Riau Landscape": "Riau Landscape Project Manager",
    "Direktur YMI": "Director, YMI",
    "Koordinator Resolusi Konflik Perhutanan Sosial": "Social Forestry Conflict Resolution Coordinator",
    "Direktur Bahtera Alam": "Director, Bahtera Alam",
    "Direktur Bidang Masyarakat": "Director for Community Affairs",
    "Kasi. Wilayah II Balai Gakkum Kehutanan": "Head of Region II, Forestry Law Enforcement Centre",
    "Kabid. Penaatan dan Penataan Lingkungan Hidup dan Kehutanan": "Head of Environmental and Forestry Compliance and Management",
    "Direktur LALH": "Director, LALH",
    "Direktur RSF": "Director, RSF",
    "Direktur YSKN": "Director, YSKN",
    "Direktur KBH": "Director, KBH",
    "Direktur WALHI Riau": "Director, WALHI Riau",
    "Bagan Pokja PPS Provinsi Riau": "Riau Provincial Pokja PPS Organisation Chart",
    "Bagan menampilkan hubungan kelembagaan utama. Rincian seluruh anggota tetap tersedia pada bagian berikutnya sesuai Lampiran I dan Lampiran II SK.": "The chart shows the main institutional relationships. Full member details remain available below in accordance with Annexes I and II of the decree.",
    "Bagan organisasi Pokja PPS Provinsi Riau": "Organisation chart of the Riau Provincial Pokja PPS",
    "PEMBINA & PENASIHAT": "ADVISORS",
    "Gubernur Riau · Ketua DPRD · Sekretaris Daerah": "Governor of Riau · Provincial Legislative Council Chair · Regional Secretary",
    "Unsur pemerintah daerah dan jejaring Perhutanan Sosial": "Provincial government and Social Forestry network representatives",
    "KETUA": "CHAIR",
    "KETUA HARIAN": "EXECUTIVE CHAIR",
    "WAKIL KETUA": "DEPUTY CHAIR",
    "SEKRETARIS": "SECRETARY",
    "WAKIL SEKRETARIS": "DEPUTY SECRETARY",
    "Pengelolaan DAS, Restorasi Gambut dan PS": "Watershed Management, Peatland Restoration and Social Forestry",
    "KOORDINASI BIDANG": "COORDINATION AREAS",
    "PENYIAPAN KAWASAN": "AREA PREPARATION",
    "Perencanaan dan Pemanfaatan Kawasan Hutan": "Forest Area Planning and Utilisation",
    "PENGEMBANGAN USAHA": "ENTERPRISE DEVELOPMENT",
    "BASIS DATA & SOSIALISASI": "DATABASE & OUTREACH",
    "PENGENDALIAN": "OVERSIGHT",
    "RESOLUSI KONFLIK": "CONFLICT RESOLUTION",
    "Koordinator + 7 anggota": "Coordinator + 7 members",
    "Koordinator + 14 anggota": "Coordinator + 14 members",
    "Koordinator + 8 anggota": "Coordinator + 8 members",
    "SEKRETARIAT POKJA PPS": "POKJA PPS SECRETARIAT",
    "Pelaksana koordinasi dan administrasi Pokja": "Working group coordination and administration",
    "Kepala Sekretariat + 5 anggota": "Head of Secretariat + 5 members",
    "Yayasan Gambut · Anggota Sekretariat": "Yayasan Gambut · Secretariat Member",
    "RINCIAN LAMPIRAN SK": "DECREE ANNEX DETAILS",
    "Susunan lengkap per bidang": "Full structure by coordination area",
    "Daftar jabatan dan instansi berikut mengikuti susunan pada dokumen resmi.": "The following list of positions and institutions follows the structure in the official document.",
    "PETA PERHUTANAN SOSIAL": "SOCIAL FORESTRY MAP",
    "Peta kabupaten/kota": "Regency/city map",
    "Pilih kabupaten/kota untuk menampilkan wilayah PS yang memiliki geometri.": "Select a regency/city to display Social Forestry areas with available geometry.",
    "Tutup peta": "Close map",
    "Tutup peta kabupaten": "Close regency map",
    "Peta Perhutanan Sosial berdasarkan kabupaten": "Social Forestry map by regency",
    "Wilayah Perhutanan Sosial": "Social Forestry area",
    "Citra satelit · Esri World Imagery": "Satellite imagery · Esri World Imagery",
    "Memuat citra satelit dan geometri PS…": "Loading satellite imagery and Social Forestry geometry…",
    "Belum ada geometri PS yang dapat ditampilkan untuk wilayah ini.": "No Social Forestry geometry is currently available for this area.",
    "Peta belum dapat dimuat. Silakan coba kembali.": "The map could not be loaded. Please try again.",
    "Wakil Sekretaris Pokja PPS Riau": "Deputy Secretary of Riau Pokja PPS",
    "Kasi. Wilayah I Balai PS Kampar": "Head of Region I, Kampar Social Forestry Centre",
    "Ketua Tim Kerja Penyuluhan dan Perhutanan Sosial": "Head of the Extension and Social Forestry Working Team",
    "Ketua Tim Kerja Pemanfaatan dan Penggunaan Kawasan Hutan": "Head of the Forest Area Utilisation and Use Working Team"
  });
  Object.assign(dictionaries.en, {
    "Estimasi area terindikasi terbakar": "Estimated area potentially burned",
    "Menunggu analisis citra Sentinel-2": "Awaiting Sentinel-2 imagery analysis",
    "Menunggu citra pascakejadian yang layak": "Awaiting a suitable post-event image",
    "Estimasi Area Terindikasi Terbakar": "Estimated Potentially Burned Area",
    "Poligon dibentuk otomatis dari perubahan indeks NBR pada citra Sentinel-2 sebelum dan sesudah kejadian yang didukung hotspot. Nilainya merupakan estimasi berbasis citra satelit, bukan hasil pengukuran atau verifikasi lapangan.": "Polygons are generated automatically from NBR changes in Sentinel-2 imagery before and after hotspot-supported events. Values are satellite-based estimates, not field measurements or field-verified perimeters.",
    "Pemeriksaan citra belum dijalankan.": "The imagery check has not run yet.",
    "Pemeriksaan citra otomatis menunggu proses pertama.": "The automatic imagery check is awaiting its first run.",
    "Area terindikasi terbakar": "Potentially burned area",
