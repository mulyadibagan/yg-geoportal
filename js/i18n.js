(() => {
  ...
  const dictionaries = {
    en: {
      ...
      "Menciptakan <i>green jobs</i> di tingkat desa (pembibitan, penanaman, pemantauan).": "Creating <i>green jobs</i> at the village level (nursery, planting, monitoring).",
      ...
      "Pembangunan <i>hybrid engineering</i> (APO) untuk melindungi garis pantai dan permukiman.": "Constructing <i>hybrid engineering</i> (wave breakers) to protect coastlines and settlements.",
