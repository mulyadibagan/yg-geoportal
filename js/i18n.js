(() => {
  ...
  const dictionaries = {
    en: {
      ...
      "Program peningkatan mata pencaharian berkelanjutan dan agroforestri kopi liberika untuk meningkatkan pendapatan masyarakat.": "Sustainable livelihood and Liberica coffee agroforestry programmes to increase community income.",
      "Tanpa Kelaparan": "Zero Hunger",
      "Agroforestri dan kebun kopi mendukung ketahanan pangan lokal dan diversifikasi sumber makanan.": "Agroforestry and coffee plantations support local food security and diversify food sources.",
      "Air Bersih dan Sanitasi Layak": "Clean Water and Sanitation",
      "Restorasi gambut dan pembangunan sekat kanal menjaga kualitas dan ketersediaan air bersih.": "Peatland restoration and canal blocking maintain the quality and availability of clean water.",
      "Pekerjaan Layak dan Pertumbuhan Ekonomi": "Decent Work and Economic Growth",
      "Menciptakan lapangan kerja hijau melalui kegiatan restorasi, pembibitan, dan pemantauan.": "Creating green jobs through restoration, nursery, and monitoring activities.",
      "Kota dan Permukiman Berkelanjutan": "Sustainable Cities and Communities",
      "Infrastruktur pencegahan kebakaran dan abrasi (APO) melindungi permukiman pesisir dan desa.": "Fire prevention and coastal abrasion (APO) infrastructure protect coastal settlements and villages.",
      "Penanganan Perubahan Iklim": "Climate Action",
      "Restorasi gambut dan mangrove menyerap karbon dalam jumlah besar dan mengurangi emisi gas rumah kaca.": "Peatland and mangrove restoration sequester large amounts of carbon and reduce greenhouse gas emissions.",
      "Ekosistem Lautan": "Life Below Water",
      "Restorasi mangrove dan pembangunan APO melindungi garis pantai dan keanekaragaman hayati laut.": "Mangrove restoration and APOs protect coastlines and marine biodiversity.",
      "Ekosistem Daratan": "Life on Land",
      "Restorasi hutan dan lahan gambut, serta perlindungan biodiversitas di area program.": "Restoration of forests and peatlands, and protection of biodiversity in programme areas.",
      "Kemitraan untuk Mencapai Tujuan": "Partnerships for the Goals",
      "Berkolaborasi dengan mitra pendanaan, pemerintah, dan masyarakat untuk mencapai tujuan bersama.": "Collaborating with funding partners, government, and communities to achieve common goals.",
