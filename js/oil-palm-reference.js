(function(root,factory){
  ...
  'use strict';
  var VERSION='ispo-registry-20260912-v1';
  ...
  function index(geo){
    if(!geo||geo.type!=='FeatureCollection'||!Array.isArray(geo.features)||geo.referenceVersion!==VERSION)throw Error('Versi referensi perusahaan sawit tidak sesuai');
  ...
  function attach(hotspots,geo){
    ...
    (hotspots.features||[]).forEach(function(f){
      ...
      units.forEach(function(u){var b=u.bounds;if(p[0]<b[0]||p[0]>b[2]||p[1]<b[1]||p[1]>b[3]||!contains(p,u.feature.geometry))return;
        var a=u.feature.properties;matches.set(a.COMPANY_ID,{id:a.COMPANY_ID,name:a.PO_COMPANY,regency:a.REFERENCE_DISTRICTS,referenceVersion:VERSION});
      });
