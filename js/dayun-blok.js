(function () {
  ...
  function render(code,summary,mapData,blockData){
    ...
    document.getElementById('db-crops').innerHTML=cropGroup(block,window.DayunAgroSummary.MPTS,'Pohon multiguna (MPTS)','pohon')+cropGroup(block,window.DayunAgroSummary.HORTICULTURE,'Hortikultura','tanaman');
    renderHarvest(block);
