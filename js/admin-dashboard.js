(function () {
  ...
  function dayunMonitoringSummary(report) {
    ...
    if (info.activityType === 'Sensus tanaman') {
      ...
      activityRows = [['Siklus panen', detail.harvestCycle], ['Jumlah panen', detail.harvestCount != null ? detail.harvestCount + (detail.unit ? ' ' + detail.unit : '') : ''], ['Berat total', detail.totalWeightKg != null ? detail.totalWeightKg + ' kg' : ''], ['Mutu dominan', detail.dominantGrade], ['Tujuan hasil', detail.destination], ['Status ratoon', detail.ratoonStatus], ['Rumpun induk', detail.ratoonMotherStands != null ? detail.ratoonMotherStands + ' rumpun' : ''], ['Tunas ratoon produktif', detail.ratoonShootCount != null ? detail.ratoonShootCount + ' tunas' : ''], ['Tanggal mulai ratoon', detail.ratoonStartDate], ['Tunas dibuang/afkir', detail.ratoonDiscardedCount != null ? detail.ratoonDiscardedCount + ' tunas' : '']];
