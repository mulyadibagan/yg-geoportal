...
async function init(){
  ...
  try{
    var results=await Promise.all([json("data/village-forest-analytics.json?v=20260831-pbph1"),json("data/PERHUTANAN_SOSIAL_RIAU.geojson?v=20260828-sk-sync1"),json("data/social-forestry-details.json?v=20260901-official1"),json("data/social-forestry-pkk-samj.geojson?v=20260831-samj-pkk1").catch(function(){return{features:[]}}),json("data/social-forestry-kud-agro-lestari.geojson?v=20260831-agro1").catch(function(){return{features:[]}}),json("data/social-forestry-derived-2025.geojson?v=20260831-derived1").catch(function(){return{features:[]}}),json("data/social-forestry-official-2026.geojson?v=20260901-official1").catch(function(){return{features:[]}})]),data=results[0],geo=results[1],details=results[2]||{};
    geo.features=(geo.features||[]).concat(results[3].features||[],results[4].features||[],results[5].features||[],results[6].features||[]);
