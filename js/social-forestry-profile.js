...
async function init(){
  ...
  try{
    var results=await Promise.all([json("data/village-forest-analytics.json?v=20260822-social-profile1"),json("data/PERHUTANAN_SOSIAL_RIAU.geojson?v=20260826-sk-batch3"),json("data/social-forestry-details.json?v=20260826-sk-batch3")]),data=results[0],geo=results[1],details=results[2]||{};
