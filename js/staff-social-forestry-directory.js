...
async function init(){
  try{
    var result=await Promise.all([
      ...
      window.YG_STAFF_DATA.fetch("data/social-forestry-details.json?v=20260919-ps-split1",{cache:"no-store"}).then(function(r){return r.json()}),
