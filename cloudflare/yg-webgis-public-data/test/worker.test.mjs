...
test("PBPH reference and reports require a valid staff session", async () => {
  ...
  try {
    ...
    for (const path of ["/api/staff/rspo-companies", "/api/staff/pbph-riau", "/api/staff/pbph-tree-cover-monitoring", "/api/staff/pbph-documents", "/api/staff/fire-monthly-index", "/api/staff/fire-monthly-report?month=2026-08", "/api/staff/phl-svlk-monthly-index", "/api/staff/phl-svlk-monthly-report?month=2026-08"]) {
