...
(function(){
  ...
  function configureFormByType(type){
    ...
    if(type === 'Area/Poligon Baru'){
      ...
      guidance.textContent = 'Gambar batas area atau poligon yang diusulkan pada peta.';
      geometryHelp.textContent = 'Poligon wajib digambar. Minimal tiga sudut dan tidak boleh saling memotong.';
  ...
  form.addEventListener('submit',function(event){
    ...
    if(selectedType === 'Area/Poligon Baru'){
      if(!geometryGeoJSON || geometryGeoJSON.type !== 'Polygon'){
        alert('Gambar poligon area terlebih dahulu.');
        return;
      }
