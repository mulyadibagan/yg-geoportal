...
L.control.scale({
  ...
  function appendReferenceControls(list, legend) {
    ...
    if (canRenderLegend) {
      const legendReferenceTitle = document.createElement("div");
      legendReferenceTitle.className = "legend-section-title";
      legendReferenceTitle.textContent = "DATA REFERENSI";
      legend.appendChild(legendReferenceTitle);
    }
